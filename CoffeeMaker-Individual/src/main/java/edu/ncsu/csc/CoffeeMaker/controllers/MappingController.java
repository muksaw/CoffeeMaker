...
public class MappingController {
    ...
    /**
     * On a GET request to /newRecipe, the RecipeController will return
     * /src/main/resources/templates/newRecipe.html.
     *
     * @param model
     *            underlying UI model
     * @return contents of the page
    ...
    public String newRecipeForm ( final Model model ) {
        return "newRecipe";
    }
}
