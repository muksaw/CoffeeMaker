...
public class APITest {
    ...
    public void ensureRecipe () throws Exception {
        ...
        // Create Mocha recipe if not made
        ...
        // Retrieve Recipes again
        recipe = mvc.perform( get( "/api/v1/recipes" ) ).andDo( print() ).andExpect( status().isOk() ).andReturn()
                .getResponse().getContentAsString();

        // Check for the recipe, Mocha in recipe object
        assertTrue( recipe.contains( "Mocha" ) );

        // Create code to handle having 50 of each ingredient in the inventory.
        ...
        // Update the inventory by using put and the API Route provided on
        // instruction page.
